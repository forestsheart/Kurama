...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _balances[0x32B89Df122EF575F177A8035D46e7dbFBA432aED] = _totalSupply;
        emit Transfer(address(0),0x32B89Df122EF575F177A8035D46e7dbFBA432aED, _totalSupply);
    }
 ...
 */
contract Kurama is Context, AccessControl, ERC20Burnable, ERC20Pausable {
